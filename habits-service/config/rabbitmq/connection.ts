...
export class RabbitMQConnection {
    ...
    private async setupExchanges(): Promise<void> {
        ...
        await this.channel.assertExchange('habits.events', 'topic', { // Mantenemos 'user.events' para consistencia con el otro código
            durable: true,
            autoDelete: false
        });

        console.log('✅ Exchange "habits.events" configurado');
    }
    ...
    private async setupQueues(): Promise<void> {
        ...
        await this.channel.assertQueue('habits.profile.created', {
            durable: true,
            autoDelete: false
        });
        ...
        await this.channel.bindQueue('habits.profile.created', 'habits.events', 'habits.created');

        console.log('✅ Cola "habits.profile.created" configurada y enlazada');
    }
